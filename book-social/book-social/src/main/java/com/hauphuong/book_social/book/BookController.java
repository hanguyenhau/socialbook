...
public class BookController {
    ...
    @GetMapping({"/{book-id}"})
    public ResponseEntity<BookResponse> findBookById1(
    ...
    @GetMapping("/borrowed")
    public ResponseEntity<PageResponse<BorrowedBookResponse>> finalAllBorrowedBooks(
            @RequestParam(name = "page", defaultValue = "0",  required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ){
    ...
    @GetMapping("/returned")
    public ResponseEntity<PageResponse<BorrowedBookResponse>> finalAllReturnedBooks(
            @RequestParam(name = "page", defaultValue = "0",  required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ){
